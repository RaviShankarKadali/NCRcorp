...
public class Pawn {
	...
	public void move(MovementType movementType, int newX, int newY) {
		if (movementType.equals(MovementType.MOVE)) {
			...
			if (this.pieceColor.equals(PieceColor.BLACK) && (this.xCoordinate-1)==newX && this.yCoordinate==newY ){
				this.setXCoordinate(newX);
				this.setYCoordinate(newY);
			}
			else if (this.pieceColor.equals(PieceColor.WHITE) && (this.xCoordinate)==(newX-1) && this.yCoordinate==newY ){
				this.setXCoordinate(newX);
				this.setYCoordinate(newY);
			}
